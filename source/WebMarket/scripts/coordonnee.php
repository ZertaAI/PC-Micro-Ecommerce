<?php
    /************************************************************************/
    /* 
             - Affiche les informations du visiteur connecte
             - le visiteur connecte peut modifier ses coordonnees   
    */
    /************************************************************************/
...
<div align="center">
    <form name="coordonnee" action="?page=requeteClient&type_requete=0" method="post">        
        <table align="center">
            ...
            <tr>        
                <td>Mot de passe (<b>Attention : l'ancien sera efface</b>) :</td>
        ...
        <!-- Bouton : Envoyer les changements effectues --> 
