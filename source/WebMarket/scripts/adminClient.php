<?php
	/************************************************************************/
	/* 
	        - Affiche toutes les informations sur les clients presents dans la base de donnees
	        - l'administrateur peut modifier ou supprimer les clients presents dans le base de donnees 	  		
	*/
	/************************************************************************/
	...
	if($_SESSION['admin'] == 0) {
		...
		echo "<br /><br />";
		//Recuperation des informations sur le client dans la base de donnees
