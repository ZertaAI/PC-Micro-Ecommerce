...
require_once('./lib/invoice.php'); // Assurez-vous d'avoir inclus la bonne bibliothèque pour PDF_Invoice
...
if ($nb_results == 0) {
    echo 'Panier Vide. Pas de generation de facture';
    exit;
}
...
$params = array("RemiseGlobale" => 0,
                ...
                "portTVA" => 19.6,    // valeur de la TVA à appliquer sur le montant HT
                "AccompteExige" => 0,
...
echo 'La facture a bien ete generee. <br />
